...
{
	internal static ulong smethod_0(uint uint_0, uint uint_1)
	{
		return ((ulong)uint_0 << 32) | uint_1;
	}

	private static uint smethod_1(uint uint_0, uint uint_1)
	{
		return ((uint_0 << 7) | (uint_0 >> 25)) ^ uint_1;
	}

	internal static uint smethod_2(ulong ulong_0)
	{
		return (uint)(ulong_0 >> 32);
	}

	internal static uint smethod_3(ulong ulong_0)
	{
		return (uint)ulong_0;
	}
	...
	private static uint[] smethod_5(uint[] uint_0, int int_0)
	{
	...
	internal static void smethod_6<T>(ref T gparam_0, ref T gparam_1)
	{
		T val = gparam_0;
		gparam_0 = gparam_1;
		gparam_1 = val;
	...
	internal static void smethod_8(uint[] uint_0)
	{
		...
		uint_0 = smethod_5(uint_0, uint_0.Length + 1);
