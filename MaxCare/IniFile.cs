...
public class IniFile
{
	...
	private static extern uint GetPrivateProfileStringW(string string_2, string string_3, string string_4, byte[] byte_0, uint uint_0, string BF98A61C);

	public IniFile(string string_2 = null)
	{
	...
	public string F9011213(string string_2, string string_3 = null)
	{
	...
	public void method_1(string F0300E0E, string C9B79F39, string string_2 = null)
	{
		WritePrivateProfileString(string_2 ?? string_1, F0300E0E, C9B79F39, string_0);
	}

	public void method_2(string string_2, string D9AD7F1C = null)
	{
		method_1(string_2, null, D9AD7F1C ?? string_1);
	}

	public void BB0C1824(string string_2 = null)
	{
		method_1(null, null, string_2 ?? string_1);
	}

	public bool CD8503BF(string string_2, string string_3 = null)
	{
		return F9011213(string_2, string_3).Length > 0;
	}
}
